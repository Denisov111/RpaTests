...
namespace TodoList
{
    ...
    internal sealed class TodoWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("6f88ccd4-3a30-4e81-9fbe-70dfea2c3392");
        ...
        {
            // Switch to the main thread - the call to AddCommand in TodoWindowCommand's constructor requires
            // the UI thread.
